 ...
 * ```
 *
 * Dispatch follows the three.js model: for every object in the tree, each of its
 * components that implements `IComponent.raycast` (e.g. {@link MeshRenderer})
 * is asked to test the ray, then the walk recurses into the children.
 *
 * @group IO
 */
