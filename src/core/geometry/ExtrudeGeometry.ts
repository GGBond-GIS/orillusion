...
/**
 * Geometry generated by extruding (and optionally rotating) a 2D shape
 * along a series of sections to form a 3D solid.
 * @group Geometry
 */
export class ExtrudeGeometry extends GeometryBase {
    ...
    private buildSections(shape: Vector3[], path: Vector3[]): Section[] {
        ...
        for (let i = 1; i < sectionCount; i++) {
            ...
            curSection.fixNormal = curSection.normal.clone().add(lastSection.normal).normalize();
        }
        ...
        for (let i = 0; i < sectionCount; i++) {
            ...
            for (let i = 0, count = shape.length; i < count; i++) {
                let newPoint = matrixRotate.multiplyPoint3(sourceShape[i].clone());
    ...
    private buildGeometry(shape: Vector3[], sections: Section[]): this {
        ...
        for (let i = 0; i < sectionCount; i++) {
            ...
            for (let j = 0; j < shapeVertexCount; j++) {
                ...
                let vertex = section.rotateShape[j].clone().add(section.center);
