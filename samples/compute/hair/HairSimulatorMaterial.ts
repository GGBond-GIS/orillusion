...
import { HairRenderShader } from './HairRenderShader';

export class HairSimulatorMaterial extends Material {
    doubleSided: any;
    constructor() {
        super();
        ShaderLib.register("HairRenderShader", HairRenderShader);
        let shader = new Shader();
        let pass = new RenderShaderPass('HairRenderShader', 'HairRenderShader');
