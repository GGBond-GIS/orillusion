import { Object3D, Scene3D, Engine3D, AtmosphericComponent, CameraUtil, HoverCameraController, View3D, DirectLight, KelvinUtil, BitmapTexture2D, Color, PlaneGeometry, MeshRenderer, UnLitMaterial, SphereGeometry, LitMaterial, LambertMaterial } from "@orillusion/core";
import { GUIHelp } from "@orillusion/debug/GUIHelp";
import { GUIUtil } from "@samples/utils/GUIUtil";

class Sample_LambertMaterial {
    lightObj3D: Object3D;
    scene: Scene3D;
    ...
    async initScene(scene: Scene3D) {
        ...
        // add a unlit sphere
        {
            ...
            renderer.material = new LambertMaterial()
            sphere.scaleX = 5;
            sphere.scaleY = 5;
            sphere.scaleZ = 5;
            sphere.y = 10;
...
new Sample_LambertMaterial().run();
